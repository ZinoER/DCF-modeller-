...
depr1 <- depreciation * (1 + hg_depreciation_delta)
...
depr2 <- depr1 * (1 + hg_depreciation_delta)
...
depr3 <- depr2 * (1 + hg_depreciation_delta)
...
depr4 <- depr3 * (1 + hg_depreciation_delta)
...
depr5 <- depr4 * (1 + hg_depreciation_delta)
